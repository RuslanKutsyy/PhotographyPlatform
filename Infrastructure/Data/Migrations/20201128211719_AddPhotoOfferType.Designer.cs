...
namespace Infrastructure.Data.Migrations
{
    ...
    [Migration("20201128211719_AddPhotoOfferType")]
    partial class AddPhotoOfferType
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Core.Entities.PhotoOffer", b =>
                {
                    ...
                    b.Property<int>("PhotoOfferTypeId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Core.Entities.PhotoOfferType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Core.Entities.PhotoOffer", b =>
                {
                    ...
                    b.HasOne("Core.Entities.PhotoOfferType", "PhotoOfferType")
                        .WithMany()
                        .HasForeignKey("PhotoOfferTypeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
